...
public class ComentarioController {
	...
	/*IMPORTANTE: AQUI EM ADICIONAR um objeto Comentario é quem deve buscar do gestaoOrdemServico e depois usamos um motodo que chamamos
	 * de toModel para que ele conversa do Model Comentario do Domain em um ComentarioModel que é um Representation Model da API
	 * */
