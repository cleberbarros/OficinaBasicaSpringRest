...
public class OrdemServicoController {
	...
	public OrdemServicoModel criar(@Valid @RequestBody OrdemServicoInput ordemServicoInput) {  //@Valid para ativar os Bean validation
		OrdemServico ordemServico = toEntidade(ordemServicoInput);
	...
	//REFATORAMOS O COMANDO ACIMA no metodo buscar: OrdemServicoModel ordemServicoModel = modelMapper.map(ordemServico.get(), OrdemServicoModel.class);
	...
	private OrdemServico toEntidade(OrdemServicoInput ordemServicoInput) {
